...
## Load parameters
parser = argparse.ArgumentParser(description='Genetic Algorithm for Multi-Project Scheduling')
...
parser.add_argument("--DATA",type=str,default='data/data-J5-O8-M5-S376.txt',help="path to dataset")
